/*
  ...
  - A unique constraint covering the columns `[name]` on the table `sla` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE `history_state_images` MODIFY `uploaded_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(3);
...
-- AlterTable
ALTER TABLE `ticket_images` MODIFY `uploaded_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(3);
...
-- AlterTable
ALTER TABLE `users` ADD COLUMN `document_id` VARCHAR(50) NULL,
